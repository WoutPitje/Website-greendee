...
export interface ApiReferenceReference extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Uitgevoerde projecten van GreenDee';
  ...
  attributes: {
    ...
    imageIsLogo: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    status: Schema.Attribute.Enumeration<['Gerealiseerd', 'In ontwikkeling']> &
      Schema.Attribute.Required &
